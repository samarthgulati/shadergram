...
var css_gradients_glsl_fns = [
  {
    ...
    inputs: [
      {
        type: "float",
        name: "r1",
        default: Math.floor(1.0 * 255)
      },{
        type: "float",
        name: "g1",
        default: Math.floor(0.99 * 255)
      },{
        type: "float",
        name: "b1",
        default: Math.floor(0.67 * 255)
      },{
        type: "float",
        name: "x1",
        default: -0.5
        ...
        type: "float",
        name: "r2",
        default: Math.floor(0.91 * 255)
      },{
        type: "float",
        name: "g2",
        default: Math.floor(0.06 * 255)
      },{
        type: "float",
        name: "b2",
        default: Math.floor(0.47 * 255)
      },{
        type: "float",
        name: "x2",
        default: 0.5
    ...
    vec3 color1 = pow(vec3(r1, g1, b1) / 255.0, vec3(2.2));
    vec3 color2 = pow(vec3(r2, g2, b2) / 255.0, vec3(2.2));
    ...
    inputs: [
      {
        type: "float",
        name: "r1",
        default: Math.floor(0.63 * 255)
      },{
        type: "float",
        name: "g1",
        default: Math.floor(0.88 * 255)
      },{
        type: "float",
        name: "b1",
        default: Math.floor(0.34 * 255)
      },{
        type: "float",
        name: "x1",
        default: 0
        ...
        type: "float",
        name: "r2",
        default: Math.floor(0.64 * 255)
      },{
        type: "float",
        name: "g2",
        default: Math.floor(0.98 * 255)
      },{
        type: "float",
        name: "b2",
        default: Math.floor(0.95 * 255)
      },{
        type: "float",
        name: "x2",
        default: 0.5
    ...
    inputs: [
      {
        ...
        type: "float",
        name: "g1",
        default: Math.floor(0.25 * 255)
      },{
        type: "float",
        name: "b1",
        default: Math.floor(0.28 * 255)
      },{
        type: "float",
        name: "cx",
        default: 0
        ...
        type: "float",
        name: "r2",
        default: Math.floor(0.14 * 255)
      },{
        type: "float",
        name: "g2",
        default: Math.floor(0.15 * 255)
      },{
        type: "float",
        name: "b2",
        default: Math.floor(0.27 * 255)
      }
    ],
    // https://www.shadertoy.com/view/ldtSzM
    glsl: `   vec3 color1 = pow(vec3(r1, g1, b1) / 255.0, vec3(2.2));
    vec3 color2 = pow(vec3(r2, g2, b2) / 255.0, vec3(2.2));
